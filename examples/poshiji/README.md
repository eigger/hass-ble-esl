...
[제품·구매·프로토콜 안내](../../docs/xte-psj420.md)
...
| `target.device_id` | `<your device>` 자리표시자. 본인의 BLE ESL 장치 ID로 변경 |
...
이 자동화는 `ble_esl.write`를 사용하고 미리보기 전용 옵션이 없으므로 실행하면 실제 전송합니다. 같은 장치를 대상으로 하는 다른 자동화와 동시에 실행되지 않도록 하세요.
